...
export function SetupScreen() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 px-4 text-zinc-100">
      <div className="w-full max-w-xl rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 shadow-xl shadow-black/40">
        ...
        <ol className="mt-6 space-y-3 text-sm text-zinc-300">
          <li>
            <span className="font-medium text-zinc-100">1. Create a project</span>{" "}
            in{" "}
            <Link
          ...
          <li>
            ...
            under{" "}
            <span className="font-mono text-xs bg-zinc-800/80 px-1.5 py-0.5 rounded">
              Settings → API
            </span>
            .
          </li>
          <li>
            ...
            <pre className="mt-2 rounded-lg bg-zinc-900 px-3 py-2 text-xs text-zinc-200">
{`# .env.local
